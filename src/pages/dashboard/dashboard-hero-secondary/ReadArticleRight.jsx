        ...
        <div className="max-w-screen-2xl mx-auto">
          <div className="grid grid-cols-4">
            ...
            <div className="md:relative ">
              <div class="md:absolute w-[28rem] h-auto md:translate-y-20 md:-translate-x-36 mx-0 p-12  bg-white  border-gray-200 rounded-md ">
                <a href="#">
                ...
                <a
                  href="#"
                  class="inline-flex items-center py-3 px-7 text-sm font-medium text-center  text-white bg-primary-red rounded-md"
                >
                  Read full Article
                </a>
              </div>
...
export default ReadArticleRight;
