        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="grid grid-cols-4">
            <div className="md:relative">
              <div class="md:absolute w-[24rem] md:translate-x-10 md:translate-y-20 mx-0 p-10 bg-white  border-gray-200 ">
                <a href="#">
                  <h5 class="mb-2 text-2xl font-bold tracking-tight text-primary-black">
                ...
                <a
                  href="#"
                  class="inline-flex items-center py-2 px-3 text-sm font-medium text-center  text-white bg-primary-red"
                >
                  Read more
                </a>
              </div>
